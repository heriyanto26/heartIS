...
public class AdminHistoryDetail extends AppCompatActivity {
    ...
    Button btnBack;
    String namaMahasiswa, namaPsikolog, media, date, time, medicalNotes, dateTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtMedicalNotes = findViewById(R.id.txtMedicalNotes);
     ...
     private void getMedicalNotes(String Name){
        RequestQueue queue = Volley.newRequestQueue(AdminHistoryDetail.this);
