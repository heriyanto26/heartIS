...
public class AdminNamePickerNotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_name_picker_notes);
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), AdminMedicalNotesDetail.class);
    ...
    private void loadJsonData() {
        RequestQueue queue = Volley.newRequestQueue(AdminNamePickerNotes.this);
